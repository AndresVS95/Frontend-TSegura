...
import MapaInteractivo from './MapaInterativo';
...
const EventoDetalle: React.FC = () => {
  ...
  <div className="min-h-screen bg-gray-50 pb-20">
    ...
    <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12">
      ...
      {/* COLUMNA IZQUIERDA: Imagen e Información Principal (Ocupa 2 columnas) */}
      ...
      {/* COLUMNA DERECHA: Mapa y Selección de Boletas */}
      <div className="space-y-6">
        
        {/* --- NUEVA SECCIÓN: EL MAPA INTERACTIVO --- */}
        <div className="bg-white p-4 rounded-[2.5rem] shadow-xl border border-gray-50">
          <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4 ml-4">Mapa del Recinto</h3>
          <div className="aspect-square bg-gray-100 rounded-[1.5rem] overflow-hidden flex items-center justify-center">
            <MapaInteractivo />
          </div>
        </div>
        {/* --- FIN SECCIÓN MAPA --- */}

        {/* Card de Selección de Zonas */}
